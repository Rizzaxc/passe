...
import '../../core/model/sport_profile.dart' show BadmintonProfile;
import 'elo_seed_field.dart';
import 'sport_profile_controller.dart';

class BadmintonProfileWidget extends ConsumerWidget {
  const BadmintonProfileWidget({super.key});

  void _update(WidgetRef ref, BadmintonProfile updated) {
    ref.read(badmintonProfileControllerProvider.notifier).updateDraft(updated);
  }
