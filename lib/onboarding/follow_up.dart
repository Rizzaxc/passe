...
/// feature-intro coach-marks. The profile sheet is signed-in only — guests
/// can't persist profile edits, so there's little for a non-interactive
/// preview to accomplish; a declining guest skips all three until they sign
/// up. Safe to call from the shell's `initState` on every launch — each
/// step is individually gated on its own persisted "done" flag, so a step
