...
/// Create a copy of UserDetails
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? gender = freezed,Object? ageGroup = freezed,Object? playtime = null,Object? location = freezed,Object? sport = null,}) {
  return _then(_self.copyWith(
...
as UserLocation?,sport: null == sport ? _self.sport : sport // ignore: cast_nullable_to_non_nullable
...
class _UserDetails implements UserDetails {
  const _UserDetails({this.gender, this.ageGroup, final  List<Timeslot> playtime = const [], this.location, final  Map<String, SportProfile> sport = const {}}): _playtime = playtime,_sport = sport;
...
@override@JsonKey() Map<String, SportProfile> get sport {
...
/// Create a copy of UserDetails
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? gender = freezed,Object? ageGroup = freezed,Object? playtime = null,Object? location = freezed,Object? sport = null,}) {
...
as List<Timeslot>,location: freezed == location ? _self.location : location // ignore: cast_nullable_to_non_nullable
as UserLocation?,sport: null == sport ? _self._sport : sport // ignore: cast_nullable_to_non_nullable
as Map<String, SportProfile>,
  ));
}
