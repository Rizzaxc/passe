...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,userId,date,restingHeartRate,hrvSdnnMs,steps,distanceMeters,activeCalories,totalCalories,sleepMinutes,sleepQualityScore,weightKg,activityCount,totalActivityMinutes,syncedAt);

@override
String toString() {
  return 'DailyHealthSummary(userId: $userId, date: $date, restingHeartRate: $restingHeartRate, hrvSdnnMs: $hrvSdnnMs, steps: $steps, distanceMeters: $distanceMeters, activeCalories: $activeCalories, totalCalories: $totalCalories, sleepMinutes: $sleepMinutes, sleepQualityScore: $sleepQualityScore, weightKg: $weightKg, activityCount: $activityCount, totalActivityMinutes: $totalActivityMinutes, syncedAt: $syncedAt)';
}
...
switch (_that) {
case _DailyHealthSummary() when $default != null:
return $default(_that.userId,_that.date,_that.restingHeartRate,_that.hrvSdnnMs,_that.steps,_that.distanceMeters,_that.activeCalories,_that.totalCalories,_that.sleepMinutes,_that.sleepQualityScore,_that.weightKg,_that.activityCount,_that.totalActivityMinutes,_that.syncedAt);case _:
  return orElse();
...
/// Create a copy of DailyHealthSummary
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? userId = null,Object? date = null,Object? restingHeartRate = freezed,Object? hrvSdnnMs = freezed,Object? steps = freezed,Object? distanceMeters = freezed,Object? activeCalories = freezed,Object? totalCalories = freezed,Object? sleepMinutes = freezed,Object? sleepQualityScore = freezed,Object? weightKg = freezed,Object? activityCount = null,Object? totalActivityMinutes = null,Object? syncedAt = freezed,}) {
