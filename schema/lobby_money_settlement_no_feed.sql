-- Pairwise money settlement is private bookkeeping between two lobby members.
-- Do not publish a system event to the lobby's general feed. Existing feed
-- history is intentionally preserved; only future settlements are affected.
