...
[`lib/social/AGENTS.md`](lib/social/AGENTS.md).

Each tab folder ships its own `AGENTS.md` with the file map, providers, and screen-specific
gotchas — read it before touching that screen:
[`lib/feed_tab/AGENTS.md`](lib/feed_tab/AGENTS.md),
[`lib/home_tab/AGENTS.md`](lib/home_tab/AGENTS.md),
[`lib/manage_tab/AGENTS.md`](lib/manage_tab/AGENTS.md),
[`lib/health_tab/AGENTS.md`](lib/health_tab/AGENTS.md),
[`lib/profile_tab/AGENTS.md`](lib/profile_tab/AGENTS.md).
...
shapes, Dart models, actions) live in [`lib/home_tab/AGENTS.md`](lib/home_tab/AGENTS.md). The
...
- Client: `challenger_section/send_challenge_controller.dart` (send — moved here from
  ...
  root AGENTS.md ▸ Notifications for the per-lobby-routing rule these all follow. Client-side kind
...
- **As actually built**, scheduling is captain/coordinator-only end to end (the "member proposes →
  captain vetoes" flow was never implemented — see `lib/manage_tab/AGENTS.md`). Members RSVP
...
Full client contract: [`lib/feed_tab/AGENTS.md`](lib/feed_tab/AGENTS.md) and
[`lib/social/AGENTS.md`](lib/social/AGENTS.md).
...
Single-context layout. Domain language currently lives in `AGENTS.md`; `CONTEXT.md` + `docs/adr/` are where it moves when separated. See `docs/agents/domain.md`.
